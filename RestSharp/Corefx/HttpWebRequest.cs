    ...
    public class HttpWebRequest : WebRequest, ISerializable
    {
        ...
        private class HttpClientParameters
        {
            ...
            public HttpClientParameters(HttpWebRequest webRequest)
            {
                ...
                Timeout = webRequest.Timeout == System.Threading.Timeout.Infinite
...
//#endif
        ...
        public virtual bool HaveResponse
        {
            get
            {
                return (_sendRequestTask != null) && (_sendRequestTask.IsCompleted && !_sendRequestTask.IsFaulted && !_sendRequestTask.IsCanceled);
            }
        }
        ...
        public override WebResponse GetResponse()
        {
            ...
            {
                throw new WebException("Sumpin gone wrong", ex);
        ...
        public override Stream EndGetRequestStream(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException("EndGetRequestStream");
            }
        ...
        public override WebResponse EndGetResponse(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException("EndGetResponse");
            }
        ...
        public void AddRange(string rangeSpecifier, long from, long to)
        {
            ...
            {
                throw new ArgumentException(nameof(rangeSpecifier));
            }
        ...
        private void CheckAbort()
        {
            ...
            {
                throw new WebException("Sumpin gone wrong");
            }
        }
